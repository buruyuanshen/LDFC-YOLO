...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None):
        ...
        #seaborn.set_theme(font_scale=1.0 if nc < 50 else 0.8)  # for label size,yuanlai
        seaborn.set_theme(font='SimHei',font_scale=1.0 if nc < 50 else 0.8)#xinjia
        plt.rcParams['font.sans-serif'] = ['SimHei']  # 用来正常显示中文标签,xinjia
        plt.rcParams['axes.unicode_minus'] = False  # 用来正常显示负号,xinjia
